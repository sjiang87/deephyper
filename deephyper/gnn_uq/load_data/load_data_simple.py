...
from deephyper.gnn_uq.data_utils import split_data_simple, get_data_simple
...
def load_data_simple(
    ...
    x_train, y_train, x_valid, y_valid, x_test, y_test = split_data_simple(
...
if __name__ == "__main__":
    _, _ = load_data_simple(dataset="qm7", verbose=1)
    _, _ = load_data_simple(dataset="qm9", verbose=1)
    _, _ = load_data_simple(dataset="delaney", verbose=1)
    _, _ = load_data_simple(dataset="lipo", verbose=1)
    _, _ = load_data_simple(dataset="freesolv", verbose=1)
