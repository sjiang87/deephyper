...
from deephyper.search.nas.model.tensorflow1x.run.util import setup_data, get_search_space
...
class NaProblem(Problem):
    ...
    >>> from deephyper.search.nas.model.tensorflow1x.baseline.simple import create_search_space
