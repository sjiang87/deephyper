...
class VariableNode(OperationNode):
    ...
    >>> from deephyper.search.nas.model.tensorflow1x.space.node import VariableNode
...
class ConstantNode(OperationNode):
    ...
    >>> import tensorflow as tf
    >>> from deephyper.search.nas.model.tensorflow1x.space.node import ConstantNode
    >>> from deephyper.search.nas.model.tensorflow1x.space.op.op1d import Dense
...
class MimeNode(OperationNode):
    ...
    >>> from deephyper.search.nas.model.tensorflow1x.space.node import VariableNode, MimeNode
    >>> from deephyper.search.nas.model.tensorflow1x.space.op.op1d import Dense
    >>> vnode = VariableNode()
    >>> vnode.add_op(Dense(10))
    >>> vnode.add_op(Dense(20))
